                                    ...
                                    var $ = function () {
                                            ...
                                            m.$set = function (t, e) {
                                                ...
                                                if (l === h || l === d) {
                                                    ...
                                                    g.init(),
                                                    this.$d = g
                                                        .set(c, Math.min(this.$D, g.daysInMonth()))
                                                        .$d
                                                } else 
                                                    p && this.$d[p](f);
                                                return this.init(),
                ...
                class u {
                    ...
                    render(t) {
                        ...
                        this
                            .dom
                            .parentNode
                            .replaceChild(this.wrapper, this.dom),
                        this
                            .container
                    ...
                    renderPager() {
                        if (n(this.pagers), this.totalPages > 1) {
                            ...
                            this.options.nextPrev && !this.onFirstPage && e.appendChild(
                            ...
                            this
                                ...
                                .classList
                                .add("active"),
                            this.options.nextPrev && !this.onLastPage && e.appendChild(
                    ...
                    destroy() {
                        ...
                        this
                            .wrapper
                            .parentNode
                            .replaceChild(this.dom, this.wrapper),
                        this.initialized = !1,
                    ...
                    fixColumns() {
                        if ((this.options.scrollY.length || this.options.fixedColumns) && this.activeHeadings && this.activeHeadings.length) {
                            ...
                            if (this.columnWidths = [], this.dom.tHead) {
                                ...
                                const s = a("tr");
                                Array
                                    .from(this.dom.tBodies[0].rows[0].cells)
                                    .forEach((() => {
                                        const e = a("th");
                                        s.appendChild(e),
                                        t.push(e)
                                    ...
                                    for (
                                        ...
                                        for (o += "(", r = 0; r < s[n].cells.length; r++) 
                                            !l
                                                ...
                                                .visible() && (o += `"${s[n].cells[r].textContent}",`);
                                        o = o
                                            .trim()
                                            .substring(0, o.length - 1),
                                        o += "),"
